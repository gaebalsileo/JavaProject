...
public class money_end {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					money_end window = new money_end();
	...
	private void initialize() {
		...
		JLabel label_1 = new JLabel("\uC120\uD0DD\uD55C \uACB0\uC81C \uC218\uB2E8 : \uB9CC\uB098\uC11C \uD604\uAE08 \uACB0\uC81C");
		...
		btnNewButton.setIcon(new ImageIcon("사진/네모 현금.jpg"));
		...
		btnNewButton_1.setBounds(137, 627, 245, 56);
