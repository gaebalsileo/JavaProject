...
public class bunsick_chickensoup {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
				bunsick_chickensoup window = new bunsick_chickensoup();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("»çÁø/´ßººÀ½ÅÁ.jpg"));
		...
		JLabel lblice = new JLabel("3.\uC5FD\uAE30 \uB2ED\uBCF6\uC74C\uD0D5");
		lblice.setFont(new Font("ºù±×·¹Ã¼", Font.PLAIN, 25));
		lblice.setForeground(Color.WHITE);
		lblice.setBounds(170, 114, 309, 65);
		frmOrderMe.getContentPane().add(lblice);
		
		JLabel label = new JLabel("\uC744(\uB97C) \uC7A5\uBC14\uAD6C\uB2C8\uC5D0 \uB123\uC5C8\uC2B5\uB2C8\uB2E4!");
		label.setFont(new Font("ºù±×·¹Ã¼", Font.PLAIN, 22));
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					BufferedWriter bos = new BufferedWriter(new FileWriter("ÁÖ¹®³»¿ª.txt",true));
					bos.write(24000+"/");
					bos.close();
					BufferedWriter bo = new BufferedWriter(new FileWriter("ÁÖ¹®À½½Ä.txt",true));
					bo.write("¿±±â ´ßººÀ½ÅÁ"+"/");
					bo.close();
				}catch (Exception ex){
				}
		...
		button_1.setIcon(new ImageIcon("»çÁø/°áÁ¦ÇÏ±â.jpg"));
		...
		button.setIcon(new ImageIcon("»çÁø/¸Þ´ºÈ­¸éÀ¸·Îµ¹¾Æ°¡±â.jpg"));
		...
		button_2.setIcon(new ImageIcon("»çÁø/Ãß°¡ ¼±ÅÃ.jpg"));
