...
public class bunsick_odol {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
				bunsick_odol window = new bunsick_odol();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("사진/오돌뼈.jpg"));
