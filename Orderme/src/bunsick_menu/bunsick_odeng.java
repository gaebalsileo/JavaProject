...
public class bunsick_odeng {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
				bunsick_odeng window = new bunsick_odeng();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("사진/오뎅.jpg"));
