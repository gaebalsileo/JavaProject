...
public class chicken_ppuringkle {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					chicken_ppuringkle window = new chicken_ppuringkle();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("사진/뿌링클.jpg"));
