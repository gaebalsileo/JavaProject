...
public class chicken_양념chicken {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					chicken_양념chicken window = new chicken_양념chicken();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("사진/양념치킨.jpg"));
		...
		JLabel lblice = new JLabel("2.\uC591\uB150 \uCE58\uD0A8");
