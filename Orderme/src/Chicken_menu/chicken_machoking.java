...
public class chicken_machoking {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					chicken_machoking window = new chicken_machoking();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("사진/맛초킹.jpg"));
		...
		JLabel lblice = new JLabel("5.\uB9DB\uCD08\uD0B9");
