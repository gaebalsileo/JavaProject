...
public class chicken_kuriqeen {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					chicken_kuriqeen window = new chicken_kuriqeen();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("사진/커리퀸.jpg"));
		...
		JLabel lblice = new JLabel("4.커리퀸");
