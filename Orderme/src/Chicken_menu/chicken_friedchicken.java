...
public class chicken_friedchicken {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					chicken_friedchicken window = new chicken_friedchicken();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("사진/후라이드 치킨.jpg"));
		...
		lblice.setBounds(172, 113, 274, 65);
