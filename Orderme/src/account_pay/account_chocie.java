...
public class account_chocie {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					account_chocie window = new account_chocie();
	...
	private void initialize() {
		...
		button.setIcon(new ImageIcon("사진/네모 계좌.jpg"));
		button.setBounds(109, 126, 317, 266);
		frmOrderMe.getContentPane().add(button);
		
		JLabel label = new JLabel("\uACC4\uC88C \uC774\uCCB4 \uACB0\uC81C\uB97C \uC120\uD0DD\uD558\uC2DC\uACA0\uC2B5\uB2C8\uAE4C?");
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				account_type c1 = new account_type();
		...
		button_3.setIcon(new ImageIcon("사진/메뉴 다시 선택하기.jpg"));
