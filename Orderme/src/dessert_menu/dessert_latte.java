...
public class dessert_latte {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					dessert_latte window = new dessert_latte();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("사진/카페라떼.jpg"));
		...
		JLabel lblice = new JLabel("2.\uCE74\uD398\uB77C\uB5BC");
