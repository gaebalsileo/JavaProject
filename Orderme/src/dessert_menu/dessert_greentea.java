...
public class dessert_greentea {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					dessert_greentea window = new dessert_greentea();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("사진/녹차라떼.jpg"));
		...
		JLabel lblice = new JLabel("3.\uB179\uCC28\uB77C\uB5BC\r\n");
