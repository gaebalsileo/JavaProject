...
public class dessert_makiyato {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					dessert_makiyato window = new dessert_makiyato();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("사진/카라멜마끼아토.jpg"));
