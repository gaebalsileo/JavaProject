...
public class dessert_americano {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					dessert_americano window = new dessert_americano();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("사진/아메리카노.jpg"));
