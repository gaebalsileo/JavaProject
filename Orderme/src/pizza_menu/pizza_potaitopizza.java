...
public class pizza_potaitopizza {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
				pizza_potaitopizza window = new pizza_potaitopizza();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("사진/포테이토.jpg"));
