...
public class pizza_cheezepizza {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
				pizza_cheezepizza window = new pizza_cheezepizza();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("사진/치즈피자.jpg"));
		...
		JLabel lblice = new JLabel("2.\uCE58\uC988 \uD53C\uC790");
