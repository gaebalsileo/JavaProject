...
public class china_gganshowseu {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					china_gganshowseu window = new china_gganshowseu();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("사진/깐쇼새우.jpg"));
		...
		JLabel lblice = new JLabel("4.\uAE50\uC1FC\uC0C8\uC6B0");
