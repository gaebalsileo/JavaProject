...
public class china_ganjjajang {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					china_ganjjajang window = new china_ganjjajang();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("사진/간짜장.jpg"));
		...
		JLabel lblice = new JLabel("3.\uAC04\uC9DC\uC7A5");
