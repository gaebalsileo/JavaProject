...
public class china_jjambbong {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					china_jjambbong window = new china_jjambbong();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("사진/짬뽕.jpg"));
