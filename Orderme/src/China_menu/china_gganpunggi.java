...
public class china_gganpunggi {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					china_gganpunggi window = new china_gganpunggi();
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("사진/깐풍기.jpg"));
		...
		JLabel lblice = new JLabel("5.\uAE50\uD48D\uAE30");
